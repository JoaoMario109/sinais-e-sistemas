...
%    
% 	\title{Trabalho: Séries de Fourier\\Engenharia Eletrônica\\Sinais e Sistemas}	\author{Alejo Perdomo Milar}
...
Objetivos:
\begin{itemize}
	\item Observar a conexão entre o período fundamental e a
	distribuição das componentes no eixo de frequência;
	\item Examinar o erro resultante da aproximação por Série de Fourier devido às
